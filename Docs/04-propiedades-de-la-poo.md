...
En el método main, creamos una instancia de "Perro" y una instancia de "Gato" y llamamos a sus métodos tanto comunes como específicos de cada clase. Esto ilustra cómo la herencia permite compartir características comunes y tener características específicas en las subclases.
